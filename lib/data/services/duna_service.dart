...
class DunaService {
  ...
  Future<DunaModel> createOrganization({
    ...
    try {
      ...
      if (statusCode == 401) {
        throw const UnauthorizedException('Please sign in to create an organization.');
      }
      if (statusCode == 404) {
        throw const NotFoundException('Genesis DUNA not found. Create the ecosystem first.');
      }
      AppLogger.error(
